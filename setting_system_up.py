...
# from config import PATH_TO_SOLR_POST_JAR_FILE_DIMA # в конфиге добавьте ваш путь до post.jar файла
# dga.index_created_documents_via_cmd(PATH_TO_SOLR_POST_JAR_FILE_DIMA) # Индексация документов
