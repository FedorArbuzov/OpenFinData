...
class M2Retrieving:
    ...
    def _refactor_mdx_skeleton(mdx_skeleton, params):
        ...
        _codes = (
            {
                'общегосударственные вопросы': '848223',
                'национальная оборона': '413284',
                'национальная безопасность и правоохранительная деятельность': '850484',
                'национальная экономика': '848398',
                'жилищно-коммунальное хозяйство': '848260',
                'охрана окружающей среды': '1203414',
                'образование': '848266',
                'культура, кинематография': '848294',
                'здравоохранение': '848302',
                'социальная политика': '848345',
                'физическая культура и спорт': '1203401'
            },
            {
                'налоговый': '12',
                'неналоговый': '13'
