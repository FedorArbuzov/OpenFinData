...
def check_the_territories(str_user):
    ...
    for _ in territories:
        distance_between_input_and_table_data = distance(delete_words_oblast_and_republic(str_user), delete_words_oblast_and_republic(territories[i]))
...
def delete_words_oblast_and_republic(str_user):
    str_user = str_user.lower().replace('республика', '').replace('республике', '').replace('республики', '')
    str_user = str_user.replace('область', '').replace('области', '')
    return str_user
...
s = s.replace('на', '')
s = s.replace('по', '')
s = s.replace('республика', '')
s = s.replace('республики', '')
s = s.replace('область', '')
s = s.replace('области', '')
