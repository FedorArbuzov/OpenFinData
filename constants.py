...
<b>Обратная связь</b>
Вы можете оставить отзыв о боте, нажав кнопку "Оценить", или написать на почту datatron.bot@gmail.com. Для нас важно ваше мнение, оно поможет сделать Datatron лучше.
